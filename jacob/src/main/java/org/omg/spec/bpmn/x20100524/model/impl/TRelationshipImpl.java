 ...
 */
public class TRelationshipImpl extends org.omg.spec.bpmn.x20100524.model.impl.TBaseElementImpl implements org.omg.spec.bpmn.x20100524.model.TRelationship
{
     ...
     */
    public org.omg.spec.bpmn.x20100524.model.TRelationshipDirection.Enum getDirection()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (org.omg.spec.bpmn.x20100524.model.TRelationshipDirection.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public org.omg.spec.bpmn.x20100524.model.TRelationshipDirection xgetDirection()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.omg.spec.bpmn.x20100524.model.TRelationshipDirection target = null;
            target = (org.omg.spec.bpmn.x20100524.model.TRelationshipDirection)get_store().find_attribute_user(DIRECTION$6);
            return target;
        }
    }
     ...
     */
    public void setDirection(org.omg.spec.bpmn.x20100524.model.TRelationshipDirection.Enum direction)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetDirection(org.omg.spec.bpmn.x20100524.model.TRelationshipDirection direction)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.omg.spec.bpmn.x20100524.model.TRelationshipDirection)get_store().add_attribute_user(DIRECTION$6);
            }
