 ...
 */
public class TParticipantMultiplicityImpl extends org.omg.spec.bpmn.x20100524.model.impl.TBaseElementImpl implements org.omg.spec.bpmn.x20100524.model.TParticipantMultiplicity
{
    ...
    public int getMinimum()
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_default_attribute_value(MINIMUM$0);
            }
            if (target == null)
            {
                return 0;
    ...
    public org.apache.xmlbeans.XmlInt xgetMinimum()
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlInt)get_default_attribute_value(MINIMUM$0);
            }
            return target;
        }
    }
    ...
    public int getMaximum()
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_default_attribute_value(MAXIMUM$2);
            }
            if (target == null)
            {
                return 0;
    ...
    public org.apache.xmlbeans.XmlInt xgetMaximum()
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlInt)get_default_attribute_value(MAXIMUM$2);
            }
            return target;
        }
    }
