 ...
 */
public class TOperationImpl extends org.omg.spec.bpmn.x20100524.model.impl.TBaseElementImpl implements org.omg.spec.bpmn.x20100524.model.TOperation
{
    ...
    private static final javax.xml.namespace.QName INMESSAGEREF$0 = 
        new javax.xml.namespace.QName("http://www.omg.org/spec/BPMN/20100524/MODEL", "inMessageRef");
    private static final javax.xml.namespace.QName OUTMESSAGEREF$2 = 
        new javax.xml.namespace.QName("http://www.omg.org/spec/BPMN/20100524/MODEL", "outMessageRef");
    private static final javax.xml.namespace.QName ERRORREF$4 = 
        new javax.xml.namespace.QName("http://www.omg.org/spec/BPMN/20100524/MODEL", "errorRef");
    private static final javax.xml.namespace.QName NAME$6 = 
        new javax.xml.namespace.QName("", "name");
    private static final javax.xml.namespace.QName IMPLEMENTATIONREF$8 = 
    ...
    public javax.xml.namespace.QName getImplementationRef()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(IMPLEMENTATIONREF$8);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlQName xgetImplementationRef()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlQName target = null;
            target = (org.apache.xmlbeans.XmlQName)get_store().find_attribute_user(IMPLEMENTATIONREF$8);
            return target;
        }
    }
    ...
    public boolean isSetImplementationRef()
    {
        ...
        {
            check_orphaned();
            return get_store().find_attribute_user(IMPLEMENTATIONREF$8) != null;
        }
    }
    ...
    public void setImplementationRef(javax.xml.namespace.QName implementationRef)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(IMPLEMENTATIONREF$8);
            }
    ...
    public void xsetImplementationRef(org.apache.xmlbeans.XmlQName implementationRef)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlQName)get_store().add_attribute_user(IMPLEMENTATIONREF$8);
            }
    ...
    public void unsetImplementationRef()
    {
        ...
        {
            check_orphaned();
            get_store().remove_attribute(IMPLEMENTATIONREF$8);
        }
    }
}
