 ...
 */
public class TSubChoreographyImpl extends org.omg.spec.bpmn.x20100524.model.impl.TChoreographyActivityImpl implements org.omg.spec.bpmn.x20100524.model.TSubChoreography
{
    private static final long serialVersionUID = 1L;
    
    public TSubChoreographyImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public org.omg.spec.bpmn.x20100524.model.TFlowElement getFlowElementArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (org.omg.spec.bpmn.x20100524.model.TFlowElement)get_store().find_element_user(FLOWELEMENT$1, i);
            if (target == null)
            {
    ...
    public org.omg.spec.bpmn.x20100524.model.TFlowElement insertNewFlowElement(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.omg.spec.bpmn.x20100524.model.TFlowElement target = null;
            target = (org.omg.spec.bpmn.x20100524.model.TFlowElement)get_store().insert_element_user(FLOWELEMENT$1, FLOWELEMENT$0, i);
            return target;
        }
    }
    ...
    public org.omg.spec.bpmn.x20100524.model.TArtifact getArtifactArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (org.omg.spec.bpmn.x20100524.model.TArtifact)get_store().find_element_user(ARTIFACT$3, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public org.omg.spec.bpmn.x20100524.model.TArtifact insertNewArtifact(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.omg.spec.bpmn.x20100524.model.TArtifact target = null;
            target = (org.omg.spec.bpmn.x20100524.model.TArtifact)get_store().insert_element_user(ARTIFACT$3, ARTIFACT$2, i);
            return target;
        }
    }
    ...
    public org.omg.spec.bpmn.x20100524.model.TArtifact addNewArtifact()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.omg.spec.bpmn.x20100524.model.TArtifact target = null;
            target = (org.omg.spec.bpmn.x20100524.model.TArtifact)get_store().add_element_user(ARTIFACT$2);
            return target;
        }
    }
