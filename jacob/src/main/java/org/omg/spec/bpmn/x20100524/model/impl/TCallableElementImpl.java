 ...
 */
public class TCallableElementImpl extends org.omg.spec.bpmn.x20100524.model.impl.TRootElementImpl implements org.omg.spec.bpmn.x20100524.model.TCallableElement
{
    ...
    private static final javax.xml.namespace.QName SUPPORTEDINTERFACEREF$0 = 
        new javax.xml.namespace.QName("http://www.omg.org/spec/BPMN/20100524/MODEL", "supportedInterfaceRef");
    ...
    public org.omg.spec.bpmn.x20100524.model.TInputOutputSpecification getIoSpecification()
    {
        synchronized (monitor())
        {
            ...
            target = (org.omg.spec.bpmn.x20100524.model.TInputOutputSpecification)get_store().find_element_user(IOSPECIFICATION$2, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(ioSpecification, IOSPECIFICATION$2, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public org.omg.spec.bpmn.x20100524.model.TInputOutputSpecification addNewIoSpecification()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.omg.spec.bpmn.x20100524.model.TInputOutputSpecification target = null;
            target = (org.omg.spec.bpmn.x20100524.model.TInputOutputSpecification)get_store().add_element_user(IOSPECIFICATION$2);
            return target;
        }
    }
     ...
     */
    public org.omg.spec.bpmn.x20100524.model.TInputOutputBinding[] getIoBindingArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            org.omg.spec.bpmn.x20100524.model.TInputOutputBinding[] result = new org.omg.spec.bpmn.x20100524.model.TInputOutputBinding[targetList.size()];
            targetList.toArray(result);
            return result;
        }
    }
     ...
     */
    public org.omg.spec.bpmn.x20100524.model.TInputOutputBinding getIoBindingArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.omg.spec.bpmn.x20100524.model.TInputOutputBinding target = null;
            target = (org.omg.spec.bpmn.x20100524.model.TInputOutputBinding)get_store().find_element_user(IOBINDING$4, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    /**
     * Sets array of all "ioBinding" element  WARNING: This method is not atomicaly synchronized.
     */
    public void setIoBindingArray(org.omg.spec.bpmn.x20100524.model.TInputOutputBinding[] ioBindingArray)
    {
        check_orphaned();
     ...
     */
    public void setIoBindingArray(int i, org.omg.spec.bpmn.x20100524.model.TInputOutputBinding ioBinding)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public org.omg.spec.bpmn.x20100524.model.TInputOutputBinding insertNewIoBinding(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.omg.spec.bpmn.x20100524.model.TInputOutputBinding target = null;
            target = (org.omg.spec.bpmn.x20100524.model.TInputOutputBinding)get_store().insert_element_user(IOBINDING$4, i);
            return target;
        }
    }
    ...
    public org.omg.spec.bpmn.x20100524.model.TInputOutputBinding addNewIoBinding()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.omg.spec.bpmn.x20100524.model.TInputOutputBinding target = null;
            target = (org.omg.spec.bpmn.x20100524.model.TInputOutputBinding)get_store().add_element_user(IOBINDING$4);
            return target;
        }
    }
